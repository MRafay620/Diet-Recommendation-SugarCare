...
backend_url = "http://192.168.108.155:8080/perdict/"
            ...
            for meal_name, column, recommendation in zip(meals, st.columns(len(meals)), recommendations):
                with column:
                    ...
                    for recipe in recommendation:
                        ...
                        expander.markdown(f"- Preparation Time: {recipe['PrepTime']}min")
                        expander.markdown(f"- Total Time: {recipe['TotalTime']}min")
    ...
    def display_meal_choices(self, person, recommendations):    
        ...
        if len(recommendations) == 3:
            ...
            with breakfast_column:
                breakfast_choice = st.selectbox('Choose your breakfast:', [recipe['Name'] for recipe in recommendations[0]])
            with launch_column:
                launch_choice = st.selectbox('Choose your launch:', [recipe['Name'] for recipe in recommendations[1]])
            with dinner_column:
                dinner_choice = st.selectbox('Choose your dinner:', [recipe['Name'] for recipe in recommendations[2]])
            ...
            with breakfast_column:
                breakfast_choice = st.selectbox('Choose your breakfast:', [recipe['Name'] for recipe in recommendations[0]])
            with morning_snack:
                morning_snack = st.selectbox('Choose your morning snack:', [recipe['Name'] for recipe in recommendations[1]])
            with launch_column:
                launch_choice = st.selectbox('Choose your launch:', [recipe['Name'] for recipe in recommendations[2]])
            with dinner_column:
                dinner_choice = st.selectbox('Choose your dinner:', [recipe['Name'] for recipe in recommendations[3]])
            ...
            with afternoon_snack:
                afternoon_snack = st.selectbox('Choose your afternoon snack:', [recipe['Name'] for recipe in recommendations[3]])
            with dinner_column:
                dinner_choice = st.selectbox('Choose your dinner:', [recipe['Name'] for recipe in recommendations[4]])
